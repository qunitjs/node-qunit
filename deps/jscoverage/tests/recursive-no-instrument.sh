...
$VALGRIND jscoverage --no-highlight --verbose --exclude=.svn --exclude=1/.svn --exclude=1/2/.svn --no-instrument 1/2 --no-instrument=script.js recursive DIR > OUT
test -d DIR
sort OUT -o OUT
diff --strip-trailing-cr verbose-no-instrument.expected.out OUT
