...
try {
	...
	console.log( 'ERR> You are missing upstream QUnit library!' );
	console.log( 'ERR> Using, maybe you forgot to update the submodules:' );
	console.log( 'ERR>   git submodule init && git submodule update' );
	process.exit(1);
}
