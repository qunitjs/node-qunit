...
function appendCoverage(coverageObject) {
    if (coverageCollector && coverageObject) {
        coverageCollector.add(coverageObject);
    }
}
...
function reportCoverage() {
    if (coverageCollector) {
        ...
        reports.forEach(function (rep) {
            rep.writeReport(coverageCollector, true);
        });
    }
}
